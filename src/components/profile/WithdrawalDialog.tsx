...
export const WithdrawalDialog = ({ isOpen, onOpenChange, onConfirm, isLoading = false }: WithdrawalDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="flex flex-col gap-[10px] items-center justify-center py-[30px] px-[20px] rounded-t-[16px] border-0">
          <div className="flex items-center justify-center size-[40px] rounded-full">
            ...
            >
              ...
              <circle cx="24" cy="24" r="20" stroke="currentColor" strokeWidth="4" className="text-[#1c2d45]" />
              <path
                d="M24 16v8M24 28v2"
                stroke="currentColor"
                strokeWidth="2.5"
                strokeLinecap="round"
                className="text-[#1c2d45]"
              />
            </svg>
          </div>
          <div className="flex flex-col gap-[4px] items-center text-center">
            ...
            <p className="text-[13px] font-medium text-white leading-[1.5] w-[194px] whitespace-nowrap">
